 ...
 *
 * Disassembly of dsdt.dat, Sun Mar 17 00:25:39 2024
 *
 ...
 */
DefinitionBlock ("", "DSDT", 2, "INSYDE", "EDK2    ", 0x00000003)
{
    ...
    Scope (_SB)
    {
        ...
        Scope (I2CD)
        {
            ...
            Device (TPNL)
            {
                ...
                //        }
                //})
                CreateWordField (SBFB, \_SB.I2CD.TPNL._Y33._ADR, ADR0)  // _ADR: Address
                Method (_HID, 0, Serialized)  // _HID: Hardware ID
                {
                    If (~CondRefOf (TPLF))
                    {
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                    {
                        ...
                        If ((Arg2 == One))
                        {
                            Return (HID3) /* \_SB_.PCI0.I2C1.TPNL.HID2 */
                        }
                    }
                    Else
                    {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    HID3 = DerefOf (DerefOf (TPID [Local0]) [0x02])
                    // If ((OSYS < 0x07DC))
                    // {
