 ...
 *
 * Disassembly of dsdt.dat, Sat Mar 16 17:08:12 2024
 *
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x2FF46018, 0x06E1)
    ...
    OperationRegion (OGNS, SystemMemory, 0x2FF46FD8, 0x0000000C)
    ...
    OperationRegion (MDBG, SystemMemory, 0x2FF33018, 0x00001004)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x2FF56018, 0x0200)
        ...
        Scope (_SB.PCI0.I2C2)
        {
            Device (TPAD)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSYS < 0x07DC))
                    {
                        Return (SBFI) /* \_SB_.PCI0.I2C2.TPAD.SBFI */
                    }
    ...
    Device (WMIP)
    {
        ...
        Method (WMPS, 3, NotSerialized)
        {
            ...
            If ((Arg1 == 0x03))
            {
                ...
                {
                    PDAT = 0x0C11
                    PDAT = (0x000A0000 | PDAT)
                }
                Else
                {
                    PDAT = 0x0D0F
                    PDAT = (0x00080000 | PDAT)
                }
